            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <ul class="space-y-2">
                        ...
                        @empty
                            <li class="text-sm text-gray-600">Aucune activité récente</li>
                        @endforelse
                    </ul>
                </div>
            </div>
