<!-- resources/views/consultation_requests/edit.blade.php -->

@extends('layouts.app')

@section('content')
    <div class="container">
        <h1 class="text-2xl font-bold mb-4">Edit Consultation Request</h1>
        <form action="{{ route('consultation_requests.update', $consultationRequest->id) }}" method="POST">
            ...
            <button type="submit" class="bg-indigo-700 text-white px-4 py-2 rounded">Update</button>
        </form>
    </div>
@endsection
